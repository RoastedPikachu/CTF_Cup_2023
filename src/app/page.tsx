    ...
    <>
        ...
        <main className='relative w-[100vw] h-auto overflow-hidden'>
            ...
            <section className='relative px-[15%] mlarge:px-[7.5%] w-full mlarge:w-full h-[750px]'>
                <img src='/static/homePage/text/RaspisanieText.png' alt='Расписание' className='absolute left-[10.5%] mlarge:left-[5%] mt-[-160px] mlarge:mt-[-80px] mmedium:mt-[-75px] w-[90vw] mlarge:w-[95vw] h-[140px] mlarge:h-[50px] mmedium:h-[40px] scale-[0.9] mlarge:scale-[0.95]'/>
            ...
            <section className='relative mt-[100px] mlarge:mt-[20px] px-[15%] mmedium:px-[10%] w-full h-[670px] mlarge:h-[1250px]'>
                ...
                <img src='/static/homePage/text/OfficialDocumentsText.png' alt='Официальные документы' className='absolute right-[10%] mlarge:right-[5%] mmedium:right-[8.5%] mlarge:mt-[110px] mmedium:mt-[100px] msmall:mt-[105px] w-[95vw] mlarge:w-[97.5vw] mmedium:w-[100vw] h-[250px] mlarge:h-[90px] mmedium:h-[80px] msmall:h-[70px] scale-[0.9] mlarge:scale-[0.95]'/>
