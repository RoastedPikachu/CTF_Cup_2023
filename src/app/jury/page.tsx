    ...
    return (
        <>
            ...
            <main className='deskWide:mx-[calc((100%-1440px)/2)] px-[10%] deskWide:px-[0px] mlarge:px-[5%] w-full max-w-[1440px] pb-[100px]'>
                <img src='/static/juryPage/text/JuryText.png' alt='Жюри' className='mt-[50px] mlarge:mt-[20px] mmedium:mt-[15px] msmall:mt-[10px] w-[45%] mlarge:w-[60%] h-[100px] deskWide:h-[120px] mlarge:h-[50px] mmedium:h-[45px] msmall:h-[40px]'/>
                ...
                <PersonInfo
                    ...
                    styles={'mt-[80px] mlarge:mt-[50px] ml-[150px] deskWide:ml-[200px] mlarge:ml-[0px]'}
                />
                ...
                <PersonInfo
                    ...
                    styles={'mt-[-10px] mlarge:mt-[50px] ml-[550px] deskWide:ml-[650px] mlarge:ml-[25%] mmedium:ml-[20%] msmall:ml-[12.5%]'}
                />
                ...
                <PersonInfo
                    ...
                    styles={'mt-[80px] mlarge:mt-[50px] mmedium:mt-[80px] msmall:mt-[120px] ml-[150px] deskWide:ml-[200px] mlarge:ml-[0px]'}
                />
                ...
                <PersonInfo
                    ...
                    styles={'mt-[-80px] mlarge:mt-[50px] ml-[750px] deskWide:ml-[900px] mlarge:ml-[25%] mmedium:ml-[20%] msmall:ml-[12.5%]'}
                />
                ...
                <PersonInfo
                    ...
                    styles={'mt-[-80px] mlarge:mt-[50px] ml-[550px] deskWide:ml-[650px] mlarge:ml-[25%] mmedium:ml-[20%] msmall:ml-[12.5%]'}
                />
                ...
                <PersonInfo
                    ...
                    styles={'mt-[50px] mlarge:mt-[50px] ml-[150px] deskWide:ml-[250px] mlarge:ml-[0px]'}
                />
                ...
                <PersonInfo
                    ...
                    styles={'mt-[40px] mlarge:mt-[50px] ml-[350px] deskWide:ml-[500px] mlarge:ml-[0px]'}
                />
                ...
                <PersonInfo
                    ...
                    styles={'mt-[50px] mlarge:mt-[50px] ml-[750px] deskWide:ml-[900px] mlarge:ml-[25%] mmedium:ml-[20%] msmall:ml-[12.5%]'}
                />
                ...
                <PersonInfo
                    ...
                    styles={'mt-[40px] mlarge:mt-[50px] ml-[350px] deskWide:ml-[500px] mlarge:ml-[25%] mmedium:ml-[20%] msmall:ml-[12.5%]'}
                />
                ...
                <PersonInfo
                    ...
                    styles={'mt-[140px] mlarge:mt-[50px] ml-[0px] deskWide:ml-[50px] mlarge:ml-[0px]'}
                />
                ...
                <PersonInfo
                    ...
                    styles={'mt-[-160px] mlarge:mt-[50px] ml-[600px] deskWide:ml-[700px] mlarge:ml-[25%] mmedium:ml-[20%] msmall:ml-[12.5%]'}
                />
                ...
                <PersonInfo
                    ...
                    styles={'mt-[120px] mlarge:mt-[50px] ml-[250px] deskWide:ml-[350px] mlarge:ml-[0px]'}
                />
            </main>
