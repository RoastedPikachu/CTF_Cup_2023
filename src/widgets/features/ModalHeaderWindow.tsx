...
const ModalHeaderWindow = ({onCloseModalWindow}) => {
    return (
        <div className='fixed ml-[calc(-5%)] py-[25px] px-[20px] w-full h-[100vh] bg-[#0d0d0d] z-30'>
            <img src='/static/XMarkIcon.svg' alt='Закрыть' onClick={() => onCloseModalWindow()} className='absolute top-[25px] right-[20px] w-[20px] h-[17.5px]'/>
