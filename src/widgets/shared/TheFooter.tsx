...
const TheFooter = () => {
    return (
        <footer className='flex justify-between mlarge:block relative pt-[70px] mlarge:pt-[50px] px-[15%] w-[100%] h-[330px] mlarge:h-[700px] bg-[#000000]'>
            ...
            <p className='absolute bottom-[15px] mlarge:bottom-[50px] w-[70%] text-[rgba(255,255,255,0.6)] text-[0.5rem] font-["DaMiOne"] text-center'>@CTFCUP2023</p>
        </footer>
    )
};
