...
const Itinerary = () => {
    ...
    return (
        <section className='relative px-[15%] mlarge:px-[7.5%] w-full mlarge:w-full h-[750px]'>
            <img src='/static/homePage/text/RaspisanieText.png' alt='Расписание' className='absolute left-[10.5%] mlarge:left-[5%] mt-[-160px] mlarge:mt-[-75px] mmedium:mt-[-70px] w-[90vw] mlarge:w-[95vw] h-[120px] mlarge:h-[40px] mmedium:h-[35px] scale-[0.9] mlarge:scale-[0.95]'/>
            ...
            {!isMobile ?
                ...
                :
                <>
                    <Carousel ariaLabel='div' showThumbs={false} showIndicators={false} showStatus={false} showArrows={false} className='mt-[110px] w-full h-[480px] msmall:h-[450px] text-[#ffffff] font-["Good_Timing"]'>
